...
expName = 'Priming EXP'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\meshwa\\Documents\\PSYCHO-PY\\data\\Priming EXP_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/meshwa/Documents/PSYCHO-PY/Study_Word.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/meshwa/Documents/PSYCHO-PY/test_word.xlsx'),
